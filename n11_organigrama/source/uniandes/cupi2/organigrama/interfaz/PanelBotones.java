...
public class PanelBotones extends JPanel implements ActionListener
{
    ...
    private static final String VER_ASPIRANTES = "Ver aspirantes";
    ...
    private JButton botonVerAspirantes;
    ...
    public PanelBotones( InterfazOrganigrama io )
    {
        ...
        botonVerAspirantes = new JButton( VER_ASPIRANTES );
        botonVerAspirantes.setActionCommand(  VER_ASPIRANTES );
        botonVerAspirantes.addActionListener( this );        
        gbc.gridx = 5;
        add( botonVerAspirantes, gbc );
    ...
    public void actionPerformed( ActionEvent evento )
    {
        ...
        else if( VER_ASPIRANTES.equals( comando ) )
        {
            ventanaPrincipal.mostrarAspirantes( );
        }
    }
}
