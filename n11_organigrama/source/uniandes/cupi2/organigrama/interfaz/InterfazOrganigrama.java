/**
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: InterfazOrganigrama.java,v 1.15 2007/04/13 04:51:26 carl-veg Exp $
...
import uniandes.cupi2.organigrama.mundo.Aspirante;
...
public class InterfazOrganigrama extends JFrame
{
    ...
    {
    	Cargo c1= new Cargo("contador", 7895, null);
    	Aspirante a1= new Aspirante("12345", "		Carlos      ", c1 ); 
        Aspirante a2= new Aspirante("18956", "		Santiago    ", c1 );
        Aspirante a3= new Aspirante("15686", "		David       ", c1 );
        Aspirante a4= new Aspirante("12895", "		Carolina    ", c1 );
    	a1.darCodigo();
    	JOptionPane.showMessageDialog(null,a1.darNombre());
    		System.out.println("|CREDEDNCIAL| |NOMBRE    | |CARGO AL QUE ASPIRA");
			System.out.println(a1.darCodigo()+a1.darNombre()+a1.darCargo());
			System.out.println(a2.darCodigo()+a2.darNombre()+a2.darCargo());
			System.out.println(a3.darCodigo()+a3.darNombre()+a3.darCargo());
			System.out.println(a4.darCodigo()+a4.darNombre()+a4.darCargo());
    ...
    {
        String nombreCargo1 = JOptionPane.showInputDialog( this, "Indique el nombre del cargo 1", "Nombre Cargo", JOptionPane.QUESTION_MESSAGE );
        String nombreCargo2 = JOptionPane.showInputDialog( this, "Indique el nombre del cargo 2", "Nombre Cargo", JOptionPane.QUESTION_MESSAGE );
    ...
    {
        String codigo1 = JOptionPane.showInputDialog( this, "Indique el código del empleado 1", "Código Empleado", JOptionPane.QUESTION_MESSAGE );
        String codigo2 = JOptionPane.showInputDialog( this, "Indique el código del empleado 2", "Código Empleado", JOptionPane.QUESTION_MESSAGE );
    ...
    {
        String nivel = JOptionPane.showInputDialog( this, "Indique el nivel", "Nivel", JOptionPane.QUESTION_MESSAGE );

        try
        {
            int nivelN = Integer.parseInt( nivel );
            String resultado = empresa.metodo5( );
            JOptionPane.showMessageDialog( this, resultado, "Respuesta", JOptionPane.INFORMATION_MESSAGE );
        }
        catch( NumberFormatException e )
        {
            JOptionPane.showMessageDialog( this, "El número del nivel debe ser un valor numérico", "Error", JOptionPane.ERROR_MESSAGE );
        }
    }
